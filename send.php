...
if(isset($_POST['sendEmail']) || isset($_POST['send']))
{
    ...
    ****************************************************************************/
    ...
    //Set footer note
    $invoice->setFooternote("https://clinicgennext.com");
...
<head lang="en">
    ...
    <title>Invoice - Invoices Generated by ClinicGen.Next™</title>
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <h1>
                ClinicGen.Next™
                <small>Invoice Generated by <a href="https://clinicgennext.com">ClinicGen.Next™</a></small>
            </h1>
            <a class="logo" href="https://clinicgennext.com"><img src="images/thecreatix-logo.png" alt="ClinicGen.Next™.com Logo"/></a>
        </div>
    </header>
        ...
        <div class="container sending-panel">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h4>Send a professional crafted email with your invoice attached to anyone in the world, For Assistance Talk with Harjeet Singh.</h4>
                ...
                <div class="col-sm-6 emailForm-panel">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="ClinicGen.Next™" name="name" id="name" onkeyup="changePreValue()" autocomplete="off">
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="preview-panel">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control-static">You've received an invoice from <span id="prevName">ClinicGen.Next™</span></p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="preview-msg-pnl">
                                <div class="preview-msg">
                                    <h2><span id="emailHeading">ClinicGen.Next™</span></h2>
                                    <p>Greetings</p>
                                    <p>You've received an invoice from <span id="emailSub">ClinicGen.Next</span></p>
                                    <p>You will find a PDF attached.</p>
                                    <p id="prevMesg"></p>
                                    <p><small><strong>Invoice</strong> - Invoice generated by <a href="https://clinicgennext.com" target="_blank">clinicgennext.com</a></small></p>
                                </div>
                            </div>
                        </div>
    ...
    <footer>
        <div class="container">
            <p class="pull-left">&copy 2020 All rights are reserved to the developers.</p>
            <p class="pull-right">Developed by <a href="https://clinicgennext.com" target="_blank">Harjeet Singh</a>.</p>
        </div>
    </footer>

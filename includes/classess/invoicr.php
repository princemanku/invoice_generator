...
class invoicr extends FPDF_rotation
{
    ...
    function email($to,$from,$subject,$message,$sendToMe,$nameVal){
        ...
        $body .= $message.$eol;
        $body .= '</p>';
        $body .= '<p style="margin-top:20px;clear:both;font-size:10px;"><strong>Invoicer</strong> - Invoice generator application by <a href="http://www.thecreatix.com" target="_blank">TheCreatix.com</a></p>';
        $body .= $eol;
